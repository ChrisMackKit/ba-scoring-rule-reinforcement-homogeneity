...
fun vector_A_k_approval:: "nat \<Rightarrow> 'a set \<Rightarrow> Vector" where
...
definition plurality_scoring :: "'a Electoral_Module" where
  "plurality_scoring A p \<equiv> max_eliminator (scoring (vector_A_k_approval 1)) A p"
end
