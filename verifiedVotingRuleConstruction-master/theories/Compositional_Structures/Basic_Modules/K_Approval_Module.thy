...
fun k_approval :: "nat \<Rightarrow> 'a set \<Rightarrow> 'a Profile \<Rightarrow> 'a Pair_Vectors\<Rightarrow> 'a Result" where
  "k_approval k A p vs = max_eliminator (scoring (vector_A_k_approval k)) A p vs"
